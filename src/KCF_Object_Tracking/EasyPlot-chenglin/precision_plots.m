function [precisions, distances, averageLocationError] = precision_plots(positions, ground_truth, show)
%PRECISION_PLOT
...
% 		figure('Number','off', 'Name',['Precisions - ' title])
        grid on;
		plot(precisions, 'g-', 'LineWidth',2)
        %plot(precisions*2.0, 'k-', 'LineWidth',3)
